...
GxEPD2_4G_4G<GxEPD2_420, GxEPD2_420::HEIGHT> display(GxEPD2_420(/*CS=5*/ 22, /*DC=*/ 15, /*RST=*/ 13, /*BUSY=*/ 34));
...
void setup()
{
	...
	drawBitmaps();
	showGreyLevels();
	// Partial update is not really partial update.
  // Full screen updates take place.
